...
**Status: RESOLVED 2026-05-14 (PR #<THIS_PR>).**
...
**Urgency:** low (for the individual deferral); medium (for the meta-fix — fourth occurrence of the same pattern is the signal the tripwire was designed for). Unit tests pin the contract; happy-path guard catches the most likely regression class. Surfaced 2026-05-14 during PR #<THIS_PR>'s work on resolving #122.
