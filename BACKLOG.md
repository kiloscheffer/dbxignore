...
**Status: RESOLVED 2026-05-14 (PR #<THIS_PR>).** Closed by the DBXIGNORE_TEST_FAIL_* meta-fix — `MARKER_READ` fail point + manual-test case 4u/4v.
...
**Status: RESOLVED 2026-05-14 (PR #<THIS_PR>).** Closed by the DBXIGNORE_TEST_FAIL_* meta-fix — `STATE_PURGE` fail point + manual-test Phase 6 cases.
...
**Status: RESOLVED 2026-05-14 (PR #<THIS_PR>).** Closed by the DBXIGNORE_TEST_FAIL_* meta-fix — `BOOTOUT` fail point + manual-test-macos.sh Phase 6 case.
...
**Status: RESOLVED 2026-05-14 (PR #<THIS_PR>).** Closed by the DBXIGNORE_TEST_FAIL_* meta-fix — `DAEMON_ALIVE` fail point + manual-test Phase 6 cases. The rule-of-four meta-fix (#128's tripwire) landed: a shared `_testing.py` injection mechanism closing all four deferrals at once.
